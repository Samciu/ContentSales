...
//	@Options(useGeneratedKeys=true, keyProperty="0", keyColumn = "id")
	...
	@Results({
		...
		@Result(property = "image", column = "icon", javaType = Blob.class, typeHandler=sales.utils.ConvertBlobTypeHandler.class),
		@Result(property = "summary", column = "abstract"),
		@Result(property = "detail", column = "text", javaType = Blob.class, typeHandler=sales.utils.ConvertBlobTypeHandler.class)
	})
